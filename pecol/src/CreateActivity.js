...
class CreateActivity extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://ec2-54-187-156-131.us-west-2.compute.amazonaws.com:3004/AllActivities`).then(res => {
  ...
  handleSubmit = event => {
    ...
    axios.post(`http://ec2-54-187-156-131.us-west-2.compute.amazonaws.com:3004/allActivities`, formData, {
      headers: {
              ...
              <div style={Object.assign({}, styles.slide, styles.slide1)}>
                <div className="row">
                  ...
                  <div className="formAdmin col-md-6">
                    ...
                    <form onSubmit={this.deleteVideo}>
                      <h3>
                        Borrar video
                      </h3>
              ...
              <div style={Object.assign({}, styles.slide, styles.slide2)}>
                <div className="row">
                  ...
                  <div className="formAdmin col-md-6">
                    ...
                    <form onSubmit={this.deletePresentation}>
                      <h3>
                        Borrar presentación
                      </h3>
