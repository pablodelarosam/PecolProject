...
class AllModule extends Component {
 ...
 axios.get(`http://ec2-54-187-156-131.us-west-2.compute.amazonaws.com:3004/AllModule`)
   .then(res => {
                      ...
                      <Table className={this.props.table}>
                        <TableHead>
                          <TableRow>
                            ...
                            <TableCell numeric>ID de Curso asociado</TableCell>
                        ...
                        <TableBody>
                          {this.state.student.map(n => {
                            return (
                              <TableRow key={n.idModule}>
                                <TableCell component="th" scope="row">
                                  {n.idModule}
                                </TableCell>

                                <TableCell numeric>{n.nameModule}</TableCell>
                                <TableCell numeric>{n.moduleDescription}</TableCell>
                                <TableCell numeric>{n.idCourse}</TableCell>
