                    ...
                    <Table className={this.props.table}>
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell numeric="numeric">ID de Curso asociado</TableCell>
                      ...
                      <TableBody>
                        {
                          this.state.student.map(n => {
                            return (<TableRow key={n.idModule}>
                              <TableCell component="th" scope="row">
                                {n.idModule}
                              </TableCell>

                              <TableCell numeric="numeric">{n.nameModule}</TableCell>
                              <TableCell numeric="numeric">{n.moduleDescription}</TableCell>
                              <TableCell numeric="numeric">{n.idCourse}</TableCell>
