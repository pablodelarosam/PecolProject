...
class CreateRule extends Component {
  ...
  axios.post(`http://ec2-34-212-223-202.us-west-2.compute.amazonaws.com:3004/createRule`, formData, {
    headers: {
  ...
  deleteRule = event => {
    ...
    axios.post(`http://ec2-34-212-223-202.us-west-2.compute.amazonaws.com:3004/deleteRule`, {
  ...
  modifyRule = event => {
    ...
    axios.put(`http://ec2-34-212-223-202.us-west-2.compute.amazonaws.com:3004/modifyRule`, {
