...
class Module extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://ec2-54-187-156-131.us-west-2.compute.amazonaws.com:3004/currentModule/${idC}`).then(res => {
        ...
        <div className="dashboard_content">
          ...
          <div className="col-sm-9 sideBar-left right-part">
            ...
            <div className="container-module">
              {
                this.state.currentModule.map((data) => <div className="row">

                  <div className="col-sm-12">
                    <h2>{data.nameModule}</h2>
                    <p className="poar-border desmo">
                      {data.moduleDescription}</p>
